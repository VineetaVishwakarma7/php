  ...
  <div class="about_pg_1 row">
   ...
   <div class="col-md-6">
    <div class="about_pg_1r">
	 <h3>OUR STORY</h3>
	 <p class="mt-3">Lorem Ipsum is simply dummy text of the printing and typesetting indust orem Ipsum has been the industry's standard dummy texever since the when anunknown printer took a galley of type and scrambled it to make a type specimen book.</p>
	 <p class="mt-3">Dorem Ipsum is simply dummy consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
	 <p class="mt-3">Lorem Ipsum is simply dummy text of the printing and typesetting indust orem Ipsum has been the industry's standard dummy texever since the when anunknown printer took a galley of type and scrambled it to make a type specimen book.</p>
  ...
  <div class="row spec_1 mt-4">
     <div class="col-md-4">
	   <div class="spec_1i bg-white p-4 pt-2">
		...
		<h5 class="mt-3">Home Fast Delivery</h5>
...
<section id="testim" class="pt-4 pb-5">
 <div class="container-xl">
   <div class="row prod_1 mb-4 text-center">
     <div class="col-md-12">
	  <h6 class="h_line font_13">OUR TESTIMONIAL</h6>
	  <h2 class="mb-0 col_yell mt-3">HAPPY CUSTOMER QUOTES</h2>
	 </div>
  </div>
  ...
  <div class="carousel-inner">
      ...
      <div class="testim_1i row">
	     <div class="col-md-4">
		  <div class="testim_1i1 text-center bg-light p-4">
		    <img src="img/1.jpeg" class="rounded-circle" alt="abc">
		 ...
		 <div class="col-md-4">
		  <div class="testim_1i1 text-center bg-light p-4">
		    <img src="img/4.jpeg" class="rounded-circle" alt="abc">
		 ...
		 <div class="col-md-4">
		  <div class="testim_1i1 text-center bg-light p-4">
		    <img src="img/2.jpeg" class="rounded-circle" alt="abc">
    ...
    <div class="carousel-item carousel-item">
        <div class="testim_1i row">
	     ...
	     <div class="col-md-4">
		  <div class="testim_1i1 text-center bg-light p-4">
		    <img src="img/3.jpeg" class="rounded-circle" alt="abc">
		    <h6 class="mt-3">Eget Nulla</h6>
			<h6 class="font_13 col_light mb-3">CEO of Company</h6>
			<span class="font_13 col_yell">
				<i class="fa fa-star"></i>
		 ...
		 <div class="col-md-4">
		  <div class="testim_1i1 text-center bg-light p-4">
		    <img src="img/5.jpeg" class="rounded-circle" alt="abc">
		    <h6 class="mt-3">Dapibis Diam</h6>
			<h6 class="font_13 col_light mb-3">CEO of Company</h6>
			<span class="font_13 col_yell">
				<i class="fa fa-star"></i>
